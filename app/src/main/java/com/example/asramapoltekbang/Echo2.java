...
public class Echo2 extends AppCompatActivity {

    String urladdress="https://magangubd17.000webhostapp.com/android/displayecho2.php";
    String[] status;
    String[] nama;
    String[] tanggal;
    String[] imagepath;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_echo2);
